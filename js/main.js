(function ($) {
  ...
  function setTopSpaceHeight() {
    if (
      ...
      if ($(".top-space-margin").length) {
        $(".top-space-margin").css("margin-top", headerHeight + 500);
      }
      if ($(".top-space-padding").length) {
        $(".top-space-padding").css("padding-top", headerHeight + 320);
      }
      if ($(".ipad-top-space-margin").length) {
        if (getWindowWidth() <= menuBreakPoint) {
          $(".ipad-top-space-margin").css("margin-top", headerHeight + 150);
        } else {
  ...
  $(document).on("click", ".close-popup", function () {
    var kobeeObj = $(this).parents(".theme-demos");
    kobeeObj.removeClass("active");
